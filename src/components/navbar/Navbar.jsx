...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: theme.palette.mode === 'dark' ? '#8796A5' : '#7451f8',
      },
    },
  },
  '& .MuiSwitch-thumb': {
    backgroundColor: theme.palette.mode === 'dark' ? '#003892' : '#7451f8',
    width: 27,
    height: 27,
    '&:before': {
      content: "''",
    ...
    <div className='navbar'>
      <div className="wrapper">
        ...
        <div className="items">
          ...
          <div className="item">
          <FormGroup>
            <FormControlLabel  onClick={() => dispatch({type: "TOGGLE"})}
